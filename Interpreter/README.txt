This is an interpreter for a C-based imperative programming language. It was build during the Programming Languages and Paradigms course. It was implemented using Haskell programming language. The parser was generated using BNF Converter.
